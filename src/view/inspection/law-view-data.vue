...
<template>
  <div>
    ...
    <div class="detail-data detail-con">
      <Row>
        <i-col span="20" offset="2" class="detail-data-title">{{lawData.name}}</i-col>
      </Row>
      <Row>
        <i-col span="4" offset="2">发布单位：{{lawData.publishUnitName}}</i-col>
        <i-col span="4" offset="6">文号：{{lawData.codeNumber}}</i-col>
      </Row>
      <Row>
        <i-col span="4" offset="2">发布日期：{{lawData.publishDate}}</i-col>
        <i-col span="4" offset="6">实施日期：{{lawData.implementDate}}</i-col>
      </Row>
      <Row>
        <i-col span="4" offset="2">状态：{{lawData.statusName}}</i-col>
      </Row>
      <Row>
        <i-col span="20" offset="2" class="detail-data-content" v-html="lawData.content"></i-col>
      </Row>
      <Row>
        <i-col span="20" offset="2" style="border-top: 1px solid #e5e5e5; padding-top: 20px;">
          附件：
          <span v-for="item in lawData.annexs" :key="item">{{item}}&nbsp;&nbsp;&nbsp;&nbsp;</span>
