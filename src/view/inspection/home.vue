    ...
    <Layout>
      ...
      <div class="template">
        ...
        <Footer class="layout-footer-center">
          ...
          <div class="web-about">
            <Row>
              <i-col span="16" class="footer_content">
              ...
              <i-col span="8" style="border-right: 1px ridge #e5e5e5;">
                <Row>
...
export default {
  ...
  methods: {
    ...
    initWebTitle (val) {
      if (val === 'main') {
        global.initWebTitle('叶竹洪博客-化妆品法规-标准-质量-飞行检查数据及行业动态')
      }
      if (val === 'LW') {
        global.initWebTitle('法规-叶竹洪博客')
      }
      if (val === 'CC') {
        global.initWebTitle('标准-叶竹洪博客')
      }
      if (val === 'SC') {
        global.initWebTitle('抽检数据-叶竹洪博客')
      }
      if (val === 'FC') {
        global.initWebTitle('监督检查-叶竹洪博客')
      }
      if (val === 'AC') {
        global.initWebTitle('文章-叶竹洪博客')
      }
    }
  }
}
