...
<template>
  <div>
    ...
    <div class="detail-data detail-con">
      ...
      <!--<div  v-html="lawData.content"></div>-->
      <table class="detail-con-tab" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td colspan="10" class="detail-content" v-html="lawData.content" style="text-align:justify;"></td>
        </tr>
        <tr>
    ...
    getLawById () {
      ...
      axios.request(option).then(res => {
        if (res.data.code === 200) {
          ...
          global.initWebTitle(_this.lawData.name + '-法规-叶竹洪博客')
        }
      })
    },
    getLawTypeList (code) {
