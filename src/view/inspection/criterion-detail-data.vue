    ...
    <div class="detail-data detail-con">
      ...
      <table class="detail-con-tab" border="1" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td colspan="10" class="detail-content" v-html="criterionData.summary" style="text-align:justify; line-height: 2;"></td>
        </tr>
        <tr>
    ...
    getCriterionById () {
      ...
      axios.request(option).then(res => {
        if (res.data.code === 200) {
          ...
          global.initWebTitle(_this.criterionData.name + '-标准-叶竹洪博客')
        }
      })
    },
    handleClear (e) {
